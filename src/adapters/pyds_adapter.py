"""Адаптер для библиотеки pyds из github.com/reineking/pyds."""
...
class PyDSAdapter(BaseDempsterShaferAdapter):
    """Адаптер для реализации pyds (MassFunction)."""
    ...
    def _ensure_backend(self):
        ...
        try:
            ...
            raise ImportError(
                "Для использования PyDSAdapter установите pyds из GitHub: "
