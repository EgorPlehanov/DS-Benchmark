...
class ProfilingBenchmarkRunner(UniversalBenchmarkRunner):
    ...
    def _save_profiling_data(self, step_name: str, profile_result: CompositeProfileResult, 
        ...
        self.artifact_manager.save_json(f"{filename}_report.json", report_data, subdir="profiling/reports")
        ...
        # Совместимость со старыми путями
        self.artifact_manager.save_text(f"{filename}_info.txt", info_content, subdir="profiling/raw")
